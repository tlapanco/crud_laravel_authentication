...
<div class="container-fluid p-0">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <!-- Form -->
            <form action="{{ route('solicitudes.update',$consulta) }}" class="form" method="POST">
                @csrf
                @method('PUT')
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane fade" id="tab2">
                ...
                <div class="d-flex justify-content-end mt-5">
                    <!-- <a title="Regresar" href="" class="text-end fs-6 text-secundario"><img src="{{ asset('img/regresa.jpg')}}" width="30" height="30"></a> -->
                </div>
            </form>
            <!-- Form End -->
        </div>
