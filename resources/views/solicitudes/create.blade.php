        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 bg-primario rounded-top mb-3">
                <div class="col-12 py-4">
                    <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Crear Nueva Solicitud</h1>
            ...
            <!-- Form -->
            <form action="{{ route('solicitudes.store') }}" class="form" method="POST">
                @csrf
                @method('POST')
        ...
        <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade show active" id="tab1">
                        <section id="general-information" class="col-12 col-lg-12" >
                            ...
                            <div class="form-floating my-2">
                                <select name="idc" {{-- <-- Nombre del Campo --}} id="role_select" class="form-select form-control" autocomplete="off" value="{{ old( 'idc' ) }}" placeholder="Seleccione Cuatrimestres" >
            ...
            <div class="tab-pane fade" id="tab2">
                ...
                <div class="d-flex justify-content-end mt-5">
                    <a title="Regresar" href="{{ route('solicitudes.index') }}" class="text-end fs-6 text-secundario"><img src="{{ asset('img/regresa.jpg')}}" width="30" height="30"></a>
                </div>
            </form>
            <!-- Form End -->
        </div>
