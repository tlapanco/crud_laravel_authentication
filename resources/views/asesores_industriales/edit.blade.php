        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 bg-primario rounded-top mb-3">
                <div class="col-12 py-4">
                    <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Editar Asesor Industrial</h1>
            ...
            <!-- Form -->
            <!-- Cambiar el metodo para editar un estudiante o registro -->
            <form action="{{ route('asesores_industriales.update', $consulta) }}" class="form" method="POST">
                @csrf
                <!-- Metodo PUT es para modificar un registro, POST es para las altas  -->
                <!-- Metodo con el que se edita en un controlador de tipo restfull o resource -->
                @method('PUT')
                        ...
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2">
                                <input
                                    ...
                                    id="input-text"
                                    readonly>
                                <label for="input-text">Usuario que hara la modificaion</label>
                            </div>
                            ...
                            <div class="form-floating my-2">
                                <input
                                    ...
                                    id="input-text"
                                    required>
                                <label for="input-text">Nombre del asesor industriaal </label>
                            ...
                            <div class="form-floating my-2">
                                ...
                                value="{{ $consulta->idem }}"placeholder="Seleccione una empresa" required>
                                <option value="{{$consulta->idem}}" selected >{{$consulta->empre}}</option>
