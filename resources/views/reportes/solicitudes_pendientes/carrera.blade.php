...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="row w-100 h-100 m-0 p-0">
                            ...
                            @forelse($listas as $lista)
                                <tr class="d-none d-lg-table-row col-12">
                                    ...
                                    <td class="align-center col-4 ">
                                        @if ($lista->solis > 0)
                                        <a href="{{ route('detalle_solicitudes', ['id' => $lista->idg, 'idp' => $idp, 'idce' => $datos->idce, 'idca' => $datos->idca]) }}" class="btn btn-primario text-white btn-sm mx-auto ">Detalle solicitudes</a>
                                        @endif
                                        @if ($lista->cartas > 0)
                                        <a href="{{ route('detalle_cartas', ['id' => $lista->idg, 'idp' => $idp, 'idce' => $datos->idce, 'idca' => $datos->idca]) }}"
            ...
            <div class="col-3">
                <a href="{{ route('regresar', ['idce' => $idce, 'idp' => $idp]) }}"
            ...
            @forelse($listas as $lista)
                ...
                <div class="card shadow-lg my-3 py-3 mx-auto d-lg-none">
                    ...
                    <div class="card-body text-center">
                        <a href="{{ route('detalle_solicitudes', ['id' => $lista->idg, 'idp' => $idp, 'idce' => $datos->idce, 'idca' => $datos->idca]) }}"
