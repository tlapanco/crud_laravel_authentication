...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="row w-100 h-100 m-0 p-0">
            ...
            <!-- Header Section -->
            <form action="{{ route('detalle_solicitudes_completadas', ['id' => $idg, 'idp' => $idp, 'idce' => $datos->idce, 'idca' => $datos->idca]) }}" method="POST"
                        ...
                        <tbody id="">
                            @forelse($usuarios as $usuario)
                                <tr class="d-none d-lg-table-row">
                                    ...
                                    <td>
                                        <a href="https://google.com" class="btn btn-sm btn-primario text-white fw-bold w-20">
