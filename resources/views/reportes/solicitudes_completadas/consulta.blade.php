                                    ...
                                    @foreach ($listas as $lista)
                                        <tr class="d-none d-lg-table-row col-12">
                                            ...
                                            <td class="align-center col-2">
                                                <a href="{{ route('detalle_carreras_completadas', ['id' => $lista->idca, 'idce' => $idce, 'idp' => $idp]) }}"
        ...
        $(document).ready(function() {
            ...
            $("#ciclos").change(function(){                
                ...
                if (valciclo != 0 && valproceso !=0) {
                    $("#resultado1").load("{{ route('contenido_completadas')}}?idce=" + valciclo + "&idp=" + valproceso).serialize();   }               
            });
