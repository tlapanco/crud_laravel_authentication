        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 bg-primario rounded-top mb-3">
                <div class="col-12 py-4">
                    <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Modificar Empresa</h1>
            ...
            <!-- Form -->
            <form action="{{ route('empresas.update',$consulta) }}" class="form" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                          ...
                          <div class="form-floating my-2">
                                ...
                                id="input-text"
                                readonly>
                            <label for="input-text">Usuario que edita una empresa </label>
                            </div>
